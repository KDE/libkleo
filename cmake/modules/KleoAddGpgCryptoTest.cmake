...
macro(ADD_GPG_CRYPTO_TEST _target _testname)
    if(NOT GNUPGHOME)
        message(FATAL_ERROR "ADD_GPG_CRYPTO_TEST: GNUPGHOME needs to be set to a fullpath where a GPG configuration is available")
    endif()
    if(UNIX)
        if(APPLE)
        ...
        add_custom_command(
            ...
            COMMAND
                ...
                ${LIBKLEO_TEST_MODULE_PATH}/KleoGenerateCryptoTestWrapper.cmake
        )
